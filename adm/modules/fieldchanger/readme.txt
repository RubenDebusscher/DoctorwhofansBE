...
- jQuery UI is used to provide a more user-friendly experience.  In particular it's internal dialog module is used for adding records to the fieldchangers.  (http://jqueryui.com/)
