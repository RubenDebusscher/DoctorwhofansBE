<?php /* Smarty version 2.6.18, created on 2020-12-21 23:35:29
         compiled from xataface/actions/view_related_record.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'xataface/actions/view_related_record.html', 2, false),array('block', 'fill_slot', 'xataface/actions/view_related_record.html', 3, false),array('block', 'define_slot', 'xataface/actions/view_related_record.html', 48, false),array('block', 'collapsible_sidebar', 'xataface/actions/view_related_record.html', 55, false),array('block', 'translate', 'xataface/actions/view_related_record.html', 244, false),array('modifier', 'count', 'xataface/actions/view_related_record.html', 11, false),array('modifier', 'escape', 'xataface/actions/view_related_record.html', 12, false),array('function', 'record_view', 'xataface/actions/view_related_record.html', 18, false),array('function', 'actions_menu', 'xataface/actions/view_related_record.html', 21, false),array('function', 'block', 'xataface/actions/view_related_record.html', 47, false),array('function', 'glance_list', 'xataface/actions/view_related_record.html', 72, false),)), $this); ?>
    ...
    <?php $this->_tag_stack[] = array('use_macro', array('file' => "Dataface_Record_Template.html")); $_block_repeat=true;$this->_plugins['block']['use_macro'][0][0]->use_macro($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
        ...
        <div class="view-related-record-wrapper">
            ...
            <div class="subrecord-tabs">
            	<ul>
                <?php $this->assign('rrecords', $this->_tpl_vars['related_record']->toRecords()); ?>
                <?php $_from = $this->_tpl_vars['rrecords']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['subrecord']):
?>
                    <?php if (count($this->_tpl_vars['rrecords']) <= 1 || $this->_tpl_vars['related_record']->_relationship->hasUniqueFields($this->_tpl_vars['subrecord']->_table->tablename)): ?>
