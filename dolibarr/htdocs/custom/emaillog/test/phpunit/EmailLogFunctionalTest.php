...
/**
 * \file    test/functional/EmailLogFunctionalTest.php
 * \ingroup emaillog
 ...
 *
 * @package Testemaillog
 */
class EmailLogFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/emaillog/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('emaillog/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/emaillog/admin/about.php');
		$this->authenticate();
		return $this->assertContains('emaillog/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('emaillogwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modEmailLog_EmailLogTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEmailLog_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
