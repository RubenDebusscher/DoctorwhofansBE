...
/**
 * \file    test/phpunit/HorairetiersFunctionalTest.php
...
/**
 * Class HorairetiersFunctionalTest
 *
 ...
 *
 * @package Testhorairetiers
 */
class HorairetiersFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modHorairetiers')->click();
		} else {
			// Disable the module
			$this->byHref('modHorairetiers')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/horairetiers/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('horairetiers/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/horairetiers/admin/about.php');
		$this->authenticate();
		return $this->assertContains('horairetiers/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('horairetierswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modHorairetiers_HorairetiersTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modHorairetiers_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
