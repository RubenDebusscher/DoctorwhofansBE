 ...
 */
class modFreshprocess extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 330151;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'freshprocess';
        ...
        $this->description = "API Freshprocess";
        $this->descriptionlong = "API Freshprocess";
        $this->editor_name = 'Freshprocess';
        $this->editor_url = 'https://app.freshprocess.eu/';
        ...
        $this->picto='freshprocess@freshprocess';
        ...
        $this->config_page_url = array("freshprocess.setup.php@freshprocess");
        ...
        $this->langfiles = array("freshprocess@freshprocess");
