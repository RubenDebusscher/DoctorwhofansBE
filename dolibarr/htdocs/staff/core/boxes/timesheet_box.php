 ...
 */
class timesheet_box extends ModeleBoxes
{
	/**
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		$this->boxlabel = $langs->transnoentitiesnoconv("BoxLastTimesheets");
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("BoxTitleLastTimesheets", $max);
		$this->info_box_head = array(
			// Title text
			'text' => $text,
			// Add a link
			'sublink' => dol_buildpath('/staff/timesheet/list.php?mainmenu=hrm&leftmenu=timesheet&status=0', 1),
			// Sublink icon placed after the text
			'subpicto' => 'list',
			// Sublink icon HTML alt text
			'subtext' => $langs->trans('TimesheetsPendingApproval'),
			...
			'graph' => false
                ...
                if ($user->rights->staff->timesheet->read)
                {
                    ...
                    $sql.= " AND status = ".Timesheet::STATUS_PENDING;
                    ...
                    if ($result) {
                        ...
                        if ($num==0) $this->info_box_contents[$line][0] = array('td' => 'align="center"','text'=>$langs->trans("NoRecordedTimesheets"));
