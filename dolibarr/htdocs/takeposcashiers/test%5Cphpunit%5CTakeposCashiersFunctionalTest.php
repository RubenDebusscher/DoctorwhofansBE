...
/**
 * \file    test/phpunit/TakeposCashiersFunctionalTest.php
...
/**
 * Class TakeposCashiersFunctionalTest
 *
 ...
 *
 * @package Testtakeposcashiers
 */
class TakeposCashiersFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTakeposCashiers')->click();
		} else {
			// Disable the module
			$this->byHref('modTakeposCashiers')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/takeposcashiers/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('takeposcashiers/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/takeposcashiers/admin/about.php');
		$this->authenticate();
		return $this->assertContains('takeposcashiers/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('takeposcashierswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTakeposCashiers_TakeposCashiersTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTakeposCashiers_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
