...
if (!isset($action)) {
	...
	$res = @include "../../main.inc.php"; // If this file is called from send.php avoid load again
...
$companyname = GETPOST('companyname', 'html');
if ($companyname) dolibarr_set_const($db, 'TAKEPOS_RECEIPT_COMPANY_NAME', $companyname, 'chaine', 0, '', $conf->entity);
...
<font size="4">
<?php
if (file_exists($conf->mycompany->dir_output.'/logos/thumbs/'.$mysoc->logo_small) && $conf->global->TAKEPOS_SHOW_LOGO_RECEIPT) {
...
echo '<b>';
if ($conf->global->TAKEPOS_RECEIPT_COMPANY_NAME) echo $conf->global->TAKEPOS_RECEIPT_COMPANY_NAME;
else echo $mysoc->name;
echo '</b>'; ?>
</font>
</center>
<br>
