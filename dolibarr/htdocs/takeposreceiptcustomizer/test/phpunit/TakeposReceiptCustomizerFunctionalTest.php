...
/**
 * \file    test/phpunit/TakeposReceiptCustomizerFunctionalTest.php
...
/**
 * Class TakeposReceiptCustomizerFunctionalTest
 *
 ...
 *
 * @package Testtakeposreceiptcustomizer
 */
class TakeposReceiptCustomizerFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTakeposReceiptCustomizer')->click();
		} else {
			// Disable the module
			$this->byHref('modTakeposReceiptCustomizer')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/takeposreceiptcustomizer/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('takeposreceiptcustomizer/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/takeposreceiptcustomizer/admin/about.php');
		$this->authenticate();
		return $this->assertContains('takeposreceiptcustomizer/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('takeposreceiptcustomizerwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTakeposReceiptCustomizer_TakeposReceiptCustomizerTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTakeposReceiptCustomizer_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
